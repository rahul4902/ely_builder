...
<div class="col-12 d-flex">
    <div class="pull-left me-3 mb-3">
        <a href="{{ url('requirement_list') }}" type="button" class="btn btn-primary " ><i class="fa fa-file-lines me-2"></i> Requirement 
        </a>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-12-col-sm-12 col-xs-12">
            <form  data-parsley-validate class="form-horizontal form-label-left"
                   action="{{url('save_edit_requirement')}}" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="requirement_edit_id" value="{{$requirement_lists->id}}">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                               for="requirement_name">Requirement Name<span class="required">*</span>
                        </label>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <input type="text" id="requirement_name" name="requirement_name"
                                   ...
                                   value="@if(isset($requirement_lists->requirement_name)) {{$requirement_lists->requirement_name}} @endif"
