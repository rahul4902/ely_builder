...
public class SpinnerSourceAdapter extends BaseAdapter{
    ...
    Context _context;
    List<Source> requirementList = new ArrayList<>();
    LayoutInflater inflater;
    SpinnerSourceAdapter(Context _context, List<Source> requirementList)
    {
    ...
    public Object getItem(int position) {
        return requirementList.get(position).getSource_name();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv1.setText(requirementList.get(position).getSource_name());
