...
public class InterestedFragment extends Fragment implements RecyclerOnClick {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newLeadsRecycler = view.findViewById(R.id.interestedRecycler);
        ...
        callNewLeadFilterApi(key1, "interested");
    ...
    public void callNewLeadFilterApi(String key, String status) {
        ...
        apiInterface.getLeadFilterList(key, status).enqueue(new Callback<LeadsFilter>() {
                ...
                try {
                    ...
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (leadList == null || leadList.isEmpty()) {
                            ...
                            adapter = new LeadsFilterAdapter(requireActivity().getApplicationContext(), arrayList, InterestedFragment.this, false);
                    ...
                    Log.d("addCallLog", " call failed: " + e.getMessage());
            ...
            public void onFailure(Call<LeadsFilter> call, Throwable t) {
                dialogClass.stopProgress();
                Log.d("call Log", "response call failed: " + t.getMessage());
