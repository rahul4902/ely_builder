...
//CalendarDayAdapter
public class CalendarDayAdapter extends RecyclerView.Adapter<CalendarViewHolder>
{
    private final ArrayList<LocalDate> days;
    private final OnItemListener onItemListener;

    public CalendarDayAdapter(ArrayList<LocalDate> days, OnItemListener onItemListener)
    {
        this.days = days;
    ...
    public void onBindViewHolder(@NonNull CalendarViewHolder holder, int position)
    {
        ...
        else
        {
            ...
            if(date.equals(CalendarUtils.selectedDate))
                holder.parentView.setBackgroundResource(R.drawable.bg_date_circle);
        }
    }
