...
import propfinsolutions.realstate.app.com.propfinsolutions.date_time.Utils;
...
public abstract class MonthView extends View {
    ...
    /**
     * How many days to display at a layout.time. Days will be displayed starting with
     * {@link #mWeekStart}.
     */
    ...
    protected class MonthViewTouchHelper extends ExploreByTouchHelper {
        ...
        /**
         * Calculates the bounding rectangle of a given layout.time object.
         *
        ...
        /**
         * Generates a description for a given layout.time object. Since this
         * description will be spoken, the components are ordered by descending
         * specificity as DAY MONTH YEAR.
         *
         * @param day The day to generate a description for
         * @return A description of the layout.time object
         */
    ...
    /**
     * Handles callbacks when the user clicks on a layout.time object.
     */
