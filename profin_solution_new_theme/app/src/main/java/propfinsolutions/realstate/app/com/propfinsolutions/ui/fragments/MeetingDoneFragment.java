...
public class MeetingDoneFragment extends Fragment implements RecyclerOnClick {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_meeting_done, container, false);
        newLeadsRecycler = view.findViewById(R.id.meetingDoneRecycler);
        ...
        callNewLeadFilterApi(key1, "meeting");
    ...
    public void callNewLeadFilterApi(String key, String status) {
        ...
        apiInterface.getLeadFilterList(key, status).enqueue(new Callback<LeadsFilter>() {
                ...
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (leadList == null || leadList.isEmpty()) {
                            ...
                            adapter = new LeadsFilterAdapter(requireActivity().getApplicationContext(), arrayList, MeetingDoneFragment.this, false);
                    ...
                    Log.d("Meeting Done", "failed: " + e.getMessage());
            ...
            public void onFailure(Call<LeadsFilter> call, Throwable t) {
                ...
                Log.d("Meeting Done", "response call failed: " + t.getMessage());
