...
public class VisitDoneFragment extends Fragment implements RecyclerOnClick {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_visit_done, container, false);

        newLeadsRecycler = view.findViewById(R.id.vistDoneRecycler);
        ...
        callNewLeadFilterApi(key1, "visit");
    ...
    public void callNewLeadFilterApi(String key, String status) {
        ...
        apiInterface.getLeadFilterList(key, status).enqueue(new Callback<LeadsFilter>() {
                ...
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (leadList == null || leadList.isEmpty()) {
                            ...
                            adapter = new LeadsFilterAdapter(requireActivity().getApplicationContext(), arrayList, VisitDoneFragment.this, true);
                    ...
                    Log.d("VisitDone", "failed: " + e.getMessage());
                }
            ...
            public void onFailure(Call<LeadsFilter> call, Throwable t) {
                ...
                Log.d("VisitDone", " response call failed: " + t.getMessage());
