...
public class SpinnerProjectCustomAdapter extends BaseAdapter{

    Context _context;
    List<Project> projectList = new ArrayList<>();
    LayoutInflater inflater;
    SpinnerProjectCustomAdapter(Context _context, List<Project> projectList)
    {
    ...
    public Object getItem(int position) {
        return projectList.get(position).getProjectName();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv1.setText(projectList.get(position).getProjectName());
