...
public class BookingDoneFragment extends Fragment implements RecyclerOnClick {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newLeadsRecycler = view.findViewById(R.id.bookingDoneRecycler);
        ...
        callNewLeadFilterApi(key1, "booked");
    ...
    public void callNewLeadFilterApi(String key, String status) {
        ...
        apiInterface.getLeadFilterList(key, status).enqueue(new Callback<LeadsFilter>() {
                ...
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (leadList == null || leadList.isEmpty()) {
                            ...
                            adapter = new LeadsFilterAdapter(requireActivity().getApplicationContext(), arrayList, BookingDoneFragment.this, false);
                    ...
                    Log.e("Booking Done", "failed : "+ e.getMessage());
                }
            ...
            public void onFailure(Call<LeadsFilter> call, Throwable t) {
                ...
                Log.e("Booking Done", " responsefailed : "+ t.getMessage());
